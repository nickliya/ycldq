...
class AdbToolsView(QWidget):
    def __init__(self):
        ...
        # label
        self.label_jg1 = QLabel('间隔')
        self.label_jg2 = QLabel('间隔')
        self.label_jg3 = QLabel('间隔')
        self.label_jg4 = QLabel('间隔')
        ...
        self.line_start = QLineEdit('F5')
        self.line_stop = QLineEdit('F6')
    ...
    def __init_grid(self):
        ...
        self._main_grid.addWidget(self.line_edit1, 0, 1)
        ...
        self._main_grid.addWidget(self.line_edit2, 1, 1)
        ...
        self._main_grid.addWidget(self.line_edit3, 2, 1)
        ...
        self._main_grid.addWidget(self.line_edit4, 3, 1)
